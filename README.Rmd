...
Error mesaages also showed that Xcode and Xquartz are required, so I just installed them.

Then I successfully compiled html version of this book. However, in the process to compile pdf file, there was an error message: "! Missing { inserted.
<to be read again> 
                   \__um_group_begin: 
l.13355 \(f_\mathbf
...
". I googled and tried in many ways but still couldn't figure it out. Prof.Yan suggested me uninstall mactex and install tinytex. After I did so, I finally got the pdf version of this book.